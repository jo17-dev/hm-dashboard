...
const Navbar =(props: any)=>{
    ...
    const adminDashboard = (
        ...
        <div className={"flex flex-row pt-2 w-full " + props?.className}>
            ...
            <input type="text" name="search" placeholder={"Search something"} className="rounded-xl border border-black h-8 px-2 mt-auto mb-2 mx-auto self-auto focus:outline-none focus:border-red-500" />
        </div>
        </>
    );
